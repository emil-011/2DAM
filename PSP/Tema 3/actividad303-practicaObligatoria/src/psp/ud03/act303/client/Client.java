...
public class Client implements AutoCloseable {
	...
	/**
	 * Constructor de la clase Client. Establece la conexión con el servidor en el
	 ...
	 *
	 * @param command Comando a enviar al servidor (por ejemplo, "list .", "show
	 *                archivo.txt").
	 * @return La primera línea de la respuesta del servidor ("OK" o "KO").
	 * @throws IOException Si ocurre un error al enviar el comando o recibir la
	 *                     respuesta.
	 */
	 ...
	 *
	 * @return Un String con el listado de archivos y sus tamaños, separados por
	 *         líneas
	...
	public String readShow() throws IOException {
		...
		String numLinesStr = in.readLine();
		...
		for (int i = 0; i < numLines; i++) {
			...
			if (line == null) {
				throw new IOException("El archivo no tiene el número de líneas esperado.");
			}
