...
public class DescifraAESApp {
	...
	public DescifraAESApp(String instanciaFabricaCLave, byte[] salt, int iterations, int keySize, String mensaje,
			char[] password) {
		DescifraAESApp.instanciaFabricaCLave = instanciaFabricaCLave;
	...
	public Key getClaveCifrado() throws NoSuchAlgorithmException, InvalidKeySpecException {
		...
		// Especificamos la PBE a utilizar con la clave, el salt, las iteraciones y el
		// tamaño de clave
		PBEKeySpec especificaClave = new PBEKeySpec(this.password, this.getSalt(), this.getIterations(),
				this.getKeySize());
	...
	public String descifrarMensaje(String mensajeCifrado) throws NoSuchAlgorithmException, NoSuchPaddingException,
	...
	public static void main(String[] args) throws NoSuchAlgorithmException, InvalidKeySpecException,
		...
		DescifraAESApp descifraAES = new DescifraAESApp(instanciaFabricaCLave, salt, iterations, keySize, mensaje,
				password);
