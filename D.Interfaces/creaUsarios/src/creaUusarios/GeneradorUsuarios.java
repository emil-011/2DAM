...
public class GeneradorUsuarios {
    private static final String FILE_NAME = "usuarios_generados.csv";
    ...
    private static final boolean ESTA_LOGGEADO = false; // Estado de inicio de sesión fijo
    ...
    public static void main(String[] args) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(FILE_NAME))) {
            for (int i = 1; i <= TOTAL_USERS; i++) {
                ...
                writer.write(NOMBRE + i + ";" + APELLIDO + i + ";" + FECHA_NACIMIENTO + ";" + PERFIL + ";" + email + ";" + CONTRASENYA + ";" + ESTA_LOGGEADO);
                writer.newLine();
            }
