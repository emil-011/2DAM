...
public class VentanaCliente extends JFrame {
	...
	private void inicializarComponentes(Usuario usuario) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(VentanaCliente.class.getResource("/resources/cocheAzul.png")));
		...
		lblTalleresPicasso.setIcon(new ImageIcon(VentanaCliente.class.getResource("/resources/cocheAzul.png")));
		...
		lblNewLabel_3.setIcon(new ImageIcon(VentanaCliente.class.getResource("/resources/logout.png")));
		...
		lblCitaPrevia = new JLabel("Pedir cita previa");
		lblCitaPrevia.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				pedirCitaPreviaVentana();
			}
		});
		lblCitaPrevia.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		lblCitaPrevia.setIcon(new ImageIcon(VentanaCliente.class.getResource("/resources/calendario.png")));
		...
		lblReparaciones.setIcon(new ImageIcon(VentanaCliente.class.getResource("/resources/reparaciones.png")));
		lblReparaciones.setHorizontalAlignment(SwingConstants.CENTER);
		lblReparaciones.setVerticalTextPosition(SwingConstants.BOTTOM); // Texto debajo del ícono
		lblReparaciones.setHorizontalTextPosition(SwingConstants.CENTER); // Texto centrado
		optionsPanel.add(lblReparaciones);

	}

	protected void pedirCitaPreviaVentana() {
		VentanaCitaPrevia vcp = new VentanaCitaPrevia(this);
		vcp.setVisible(true);
